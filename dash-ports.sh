...
# Usage: ./scan.sh output.txt file1.txt file2.txt file3.txt ...

output_file="$1"
shift  # Remove the output file from arguments, leaving only input files

# Create/clear output file before writing
> "$output_file"
